  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        alert('Erro ao cadastrar funcionário: ' + error.error)
      }
    } catch (error) {
    ...
    <div className="space-y-4 lg:space-y-6">
      ...
      <div className="flex flex-col sm:flex-row items-start sm:items-center gap-4">
        ...
        <div className="flex-1">
          <h1 className="text-2xl lg:text-3xl font-bold text-gray-900">Novo Funcionário</h1>
          <p className="text-sm lg:text-base text-gray-600">Cadastre um novo funcionário</p>
        </div>
      </div>
        ...
        <CardContent>
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <div className="flex flex-col sm:flex-row gap-3 pt-4 border-t">
              ...
              <Link href="/funcionarios" className="w-full sm:w-auto">
